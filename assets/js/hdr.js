...
// ---------------------------------------------------------------------------------
// hamburger menu 
document.querySelector(".hb-menu").addEventListener("click", openHamburgerMenu);
document.querySelector("#hamburger-close-btn").addEventListener("click", closeHamburgerMenu);

function openHamburgerMenu() {
	console.log("added activeHamburger class");
	document.getElementById("hamburger-menu-id").classList.toggle("activeHamburger");
}

function closeHamburgerMenu() {
	console.log("removed activeHamburger class");
	document.getElementById("hamburger-menu-id").classList.remove("activeHamburger");
}
// ---------------------------------------------------------------------------------
// about me popup
